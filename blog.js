...
window.onload = () => {
    ...
    let bannerWidth = document.querySelector('.header-banner').getBoundingClientRect().width,
    bannerPic = document.querySelector('.header-banner');
    ...
    if (bannerWidth < 769) {
        bannerPic.src = "img/blogHeaderMobile.png";
      } else {
        bannerPic.src = "img/blogDesktop.png";
}
